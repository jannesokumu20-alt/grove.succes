...
import { Lock, Phone, Eye, EyeOff, Shield, Users, BarChart3, Lock as LockIcon } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="md:hidden min-h-screen flex flex-col bg-slate-950">
        {/* Mobile Header */}
        <div className="px-6 pt-6 pb-8 bg-slate-900 border-b border-slate-800">
          {!isSignUp ? (
            <>
            ...
            <div className="flex items-center gap-4">
              <button onClick={() => setIsSignUp(false)} className="text-slate-400 hover:text-white">
                ← Back
              </button>
              <div>
                <h2 className="text-2xl font-bold text-white">Create Account</h2>
                <p className="text-sm text-slate-400">Join Grove and start managing your Chama</p>
              </div>
            </div>
          )}
        </div>
          ...
          {!isSignUp ? (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type={showPassword ? 'text' : 'password'}
                      placeholder="Enter your password"
                      className="w-full pl-10 pr-10 py-2.5 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-500"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
                ...
                <a href="#" className="text-sm text-green-500 hover:underline inline-block">
                  Forgot password?
                </a>

                <button className="w-full py-3 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-lg">
                  Sign In
                </button>
                ...
                <button className="w-full py-3 border border-slate-700 rounded-lg text-white font-semibold flex items-center justify-center gap-2">
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <text x="0" y="20" fontSize="20" fill="currentColor">G</text>
                  </svg>
                  Sign in with Google
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <button className="w-full py-3 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-lg mt-2">
                  Create Account
                </button>
